const CACHE_NAME = 'poenta-v107-feed-b-json-cache-202606271020';
...
self.addEventListener('fetch', event => {
  ...
  if (/\/(feed|feed_b|breaking_feed|feed_b_breaking|dashboard_ops_snapshot|dashboard_simulation_history|tt_rr_simulation_feed|tt_rr_source_simulation_report|tt_rr_breaking_simulation_feed|spy_trends|spy_gap_queue|intelligence_briefing_queue)\.json$/.test(new URL(request.url).pathname)) {
