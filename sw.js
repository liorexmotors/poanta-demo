const CACHE_NAME = 'poenta-v104-tt-rr-open-simulation-202606131136';
...
self.addEventListener('fetch', event => {
  ...
  if (/\/(feed|breaking_feed|dashboard_ops_snapshot|dashboard_simulation_history|tt_rr_simulation_feed|spy_trends|spy_gap_queue|intelligence_briefing_queue)\.json$/.test(new URL(request.url).pathname)) {
