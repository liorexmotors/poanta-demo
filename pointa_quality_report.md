...
- Headline: `הכנסת מתקדמת לפיזור, ונתניהו רחוק מרוב בסקרים`
...
- Headline: `גופת גבר נמצאה אחרי שריפה ליד כביש 2`
...
- Headline: `הניו יורק טיימס מגבה את טור קריסטוף`
...
- Takeaway length 108 > 95
- Headline: `סקר: התמיכה בישראל נשחקת בקרב מצביעים דמוקרטים`
