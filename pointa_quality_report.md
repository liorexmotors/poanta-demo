...
- Headline: `פיקוד העורף הגביל התקהלויות וחינוך בקו העימות`
- Original: `לאחר לילה מתוח בצפון: הלימודים ביישובי קו העימות הושבתו`
- Source: וואלה חדשות
...
- Headline: `ארה״ב תקפה בדרום איראן בזמן מגעים להפסקת המלחמה`
...
- Headline: `יוקר המחיה בניגריה מקצץ את חגיגות עיד אל־אדחא`
...
- Headline: `הסכם ארה״ב־איראן מתעכב סביב הורמוז והגרעין`
...
- Takeaway length 96 > 95
- Headline: `ישראל מרחיבה את התקיפות בלבנון למרות הפסקת האש`
...
- Headline: `מורה מג׳ורג׳יה הואשמה בניצול עוד חמישה תלמידים`
