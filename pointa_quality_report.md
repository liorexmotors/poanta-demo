...
- Headline: `קייד קנינגהאם נכנס לחמישיית העונה הראשונה ב-NBA`
...
- Headline: `עסקת ארה״ב-איראן נתקעת על הורמוז והגרעין`
...
- Headline: `טקס סיום בגן באוהיו בוטל אחרי קטטה בין הורים`
...
- Headline: `הפסקת האש לא מחזירה את המטיילים לצפון`
...
- Headline: `טיוטת העסקה עם איראן משאירה את הגרעין פתוח`
...
- Headline: `הולכת רגל בשנות ה-20 נפצעה קשה בחיפה`
- Original: `הולכת רכב נפצעה קשה מפגיעת רכב בחיפה`
- Source: ynet - מבזקי החדשות
- URL: https://www.ynet.co.il/news/article/bkfskwbefe

### WARNING · takeaway_long · item 10
- Takeaway length 108 > 95
- Headline: `בעלי פורטלנד מקצץ בדיוק כשאבדיה אמור לקפוץ מדרגה`
...
- Headline: `פיפ״א מכניסה שיפוט בינה מלאכותית למונדיאל`
...
- Takeaway length 99 > 95
- Headline: `מוסלמים בארה״ב מגיבים לירי בסן דייגו בהתארגנות פוליטית`
...
- Takeaway length 98 > 95
- Headline: `ג׳סי ג׳יי הודיעה שבדיקת MRI אישרה שהיא נקייה מסרטן`
...
- Headline: `מקורבי נתניהו בוחנים הכרזה על התנועה האיסלאמית כטרור`
...
- Headline: `הסכם ארה״ב־איראן מתקרב אך עוד ממתין לאישור בטהרן`
