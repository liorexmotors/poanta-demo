...
- Headline: `מניות השבבים גוררות זינוק בבורסות אסיה`
...
- Headline: `טראמפ עוצר תקיפות באיראן למרות לחץ מנתניהו`
...
- Headline: `סאבוויי סגרה 7,600 סניפים בארה״ב בתוך עשור`
...
- Headline: `שיי הוביל את אוקלהומה ל-1:1 בגמר המערב`
...
- Headline: `אנבידיה עקפה תחזיות ומאשרת בייבאק של 80 מיליארד דולר`
- Original: `אנבידיה מכה את השוק: ההכנסות ברבעון זינקו ב-85%; משפרת תחזיות להמשך`
- Source: גלובס - שוק ההון
- URL: https://www.globes.co.il/news/article.aspx?did=1001543521#utm_source=RSS

### WARNING · takeaway_long · item 8
- Takeaway length 107 > 95
- Headline: `מוש בן ארי ואברהם טל משיקים סדרת וידאו לקראת מופע משותף`
...
- Headline: `כיפת הזהב של טראמפ עשויה לעלות לארה״ב 1.2 טריליון דולר`
...
- Takeaway length 107 > 95
- Headline: `לוחמת בצה״ל עוברת גיור אחרי שגילתה שאינה יהודייה הלכתית`
...
- Headline: `מוזיאון הקומוניזם בפראג משמש אזהרה פוליטית עכשווית`
...
- Takeaway length 117 > 95
- Headline: `צה״ל קרוב להרחבת התמרון בלבנון מול רחפני חיזבאללה`
...
- Takeaway length 121 > 95
- Headline: `מסוק ה״פרא״ הראשון של חיל האוויר נכנס להרכבה סופית`
- Original: `בדרך לישראל: המסוק החדש של חיל האוויר נכנס לשלב הסופי`
- Source: מעריב - חדשות
- URL: https://www.maariv.co.il/news/military/article-1323729
