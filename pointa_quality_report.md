...
- Headline: `ריאל מדריד עלתה לגמר היורוליג אחרי 90:105 על ולנסיה`
...
- Headline: `תושבת עזה נותרה בלי יציאה לחג׳ אחרי מות בעלה`
- Original: `Israeli blockade traps would-be Hajj pilgrim in Gaza`
...
- Headline: `רונאלדו שוב בראש דירוג שכר הספורטאים של פורבס`
...
- Headline: `הפנטגון פתח לציבור 46 סרטוני עב״מים ועדויות מסווגות`
...
- Headline: `המו״מ עם איראן תקוע, וטראמפ נלחץ ממחירי הדלק`
...
- Takeaway length 110 > 95
- Headline: `טולסי גבארד עוזבת את ראשות המודיעין של טראמפ`
...
- Takeaway length 118 > 95
- Headline: `בת 11 מתה מפגיעת אוטובוס בדיזנגוף`
...
- Takeaway length 106 > 95
- Headline: `13 צעירים נעצרו אחרי ניסיון קורבן בהר הבית`
...
- Takeaway length 106 > 95
- Headline: `טריבונל 7 באוקטובר יוכל להטיל עונש מוות`
...
### WARNING · headline_near_duplicate_summary · item 53
...
- Headline: `הודו מגדילה רכישת נפט מוונצואלה בגלל הורמוז`
...
- Takeaway length 127 > 95
- Headline: `קליקאפ מפטרת 22% ומתגמלת מאמצי AI`
...
- Takeaway length 102 > 95
- Headline: `Loora צמחה ל־15 מיליון משתמשי לימוד אנגלית ב־AI`
...
### WARNING · category_sport_source · item 162
- Sport source should usually be ספורט
- Headline: `הצומת שבו נהרג רז אדם גבה שלושה חיים בשנה`
- Original: `שלושה הרוגים בשנה: על הצומת המסוכן בו נהרג רז אדם`
- Source: וואלה ספורט
