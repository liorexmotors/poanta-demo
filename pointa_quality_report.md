...
- Headline: `בקאן בלטו סרטים חדשים כשאלמודובר ופרהאדי אכזבו`
...
- Headline: `קומיקאי הלייט־נייט עוברים מיוטיוב אל מודל עצמאי יותר`
...
- Headline: `עלות כיפת הזהב של טראמפ נאמדת ב-1.2 טריליון דולר`
...
- Headline: `איראן הסכימה עקרונית לוותר על אורניום מועשר`
- Original: `דיווח: איראן הסכימה לוותר על מאגר האורניום המועשר`
- Source: גלובס - בארץ
...
- Headline: `בריאות הפה נשארת מחוץ למדדי הרפואה המונעת`
...
- Headline: `פקיסטן מציעה לארח סבב קרוב במגעי ארה״ב־איראן`
...
- Headline: `גורמים בארה״ב: איראן תוותר על אורניום מועשר`
...
- Takeaway length 114 > 95
- Headline: `סוכן סמוי הפיל עשרות סוחרי נשק וסמים בצפון`
