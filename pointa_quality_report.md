...
- Headline: `נתניהו הצטרף לגינויים על סרטון בן גביר מול פעילי המשט`
...
- Headline: `צה״ל תגבר את קו הגבול בעזה אחרי חיסול עז א-דין אל-חדאד`
...
- Headline: `סקר בלבנון: 58% תומכים בפירוק חיזבאללה מנשקו`
...
- Headline: `טראמפ מציב לאיראן חלון קצר לפני החלטה על תקיפה`
- Original: `טראמפ: "נותן לאיראן כמה ימים, חייב לקבל תשובה נכונה"`
- Source: גלובס - בארץ
...
- Takeaway length 96 > 95
- Headline: `המשטרה מחפשת נעדרת בת 15 מקריית מלאכי`
- Original: `המשטרה מבקשת עזרה באיתור הנעדרת בת אל קסה, בת 15 מקריית מלאכי`
- Source: ynet - מבזקי החדשות
- URL: https://www.ynet.co.il/news/article/hytm8kojfx
...
- Headline: `אסטון וילה ירדה להפסקה ב-0:2 בגמר הליגה האירופית`
...
- Headline: `מסמך פנימי חושף מעקב פוליטי אחרי מורה בתקופת המחאה`
...
- Headline: `בן גביר אמר לשוטרים שירצה להשאיר את המשרד בידיו או בידי נאמנו`
...
- Headline: `מחקר מזהה קפיצה חדה באלימות בני נוער בישראל`
- Original: `האלימות בקרב בני הנוער גואה: אלה המתבגרים שנמצאים בקבוצת הסיכון`
- Source: הארץ - כל הכתבות
- URL: https://www.haaretz.co.il/family/2026-05-20/ty-article-magazine/.premium/0000019e-3600-df7e-a5be-3649c1a80000

### WARNING · takeaway_long · item 27
- Takeaway length 105 > 95
- Headline: `בן גביר תועד מתגרה בעצורי המשט לישראל`
...
- Takeaway length 110 > 95
- Headline: `שי ברדה מזהיר שקריית שמונה עדיין בלי בית לקראת העונה`
...
- Headline: `כתב אישום: 12 אקדחים הוברחו מירדן ברחפן`
- Original: `הבריח 12 אקדחים ממדינה זרה - באמצעות רחפן: כתב אישום הוגש נגד צעיר ישראלי`
- Source: וואלה חדשות
- URL: https://news.walla.co.il/item/3839628
...
- Takeaway length 103 > 95
- Headline: `אישום: תושב נתניה אנס אישה שניסתה לנתק קשר`
...
- Headline: `העליון הרחיב את החיסיון העיתונאי לטובת אסנהיים`
- Original: `העליון קבע: אסנהיים לא יעביר למשטרה את חומרי הריאיון עם פלדשטיין`
- Source: ynet - מבזקי החדשות
- URL: https://www.ynet.co.il/news/article/b1pmpbsjge
...
- Takeaway length 124 > 95
- Headline: `ארה״ב מאיימת על הרשות סביב תפקיד באו״ם`
...
- Summary length 234 > 220
- Headline: `ננו־קו גייסה 12 מיליון דולר סביב סוכני AI`
...
- Headline: `נציב התלונות קבע: העליון פעל בשבת בלי דחיפות`
- Original: `החלטה חריגה של הנציב אשר קולה נגד שופטי העליון: "שיתעטפו בגלימתם היהודית"`
- Source: מעריב - חדשות
- URL: https://www.maariv.co.il/news/law/article-1323787
...
- Takeaway length 113 > 95
- Headline: `ת״א ננעלה בעליות למרות נפילה חדה בעזריאלי`
...
- Takeaway length 96 > 95
- Headline: `בג״ץ אישר נוהל שמחייב ארגוני סיוע למסור רשימות עובדים`
...
- Headline: `מטא תפטר כ־100 עובדים בישראל לטובת מרוץ ה-AI`
...
- Takeaway length 101 > 95
- Headline: `אשל הנשיא התקדם לאישור עם כ־500 יחידות דיור`
...
- Takeaway length 105 > 95
- Headline: `תקווה להסכם עם איראן הקפיצה את וול סטריט`
...
- Takeaway length 96 > 95
- Headline: `אנבידיה צפויה לזנק בדוחות, אך יתרון ה-AI נשחק`
- Original: `אנבידיה תפרסם הערב דו"חות מצוינים, אבל הדומיננטיות שלה בשוק ה-AI כבר בסכנה`
- Source: דה מרקר - TechNation
- URL: https://www.themarker.com/wallstreet/2026-05-20/ty-article/.premium/0000019e-44c0-d0ff-afbe-46c0bc040000
...
- Headline: `איטליה זימנה את שגריר ישראל אחרי סרטון בן גביר`
...
- Takeaway length 103 > 95
- Headline: `עמוד אינסטגרם חושף את הבימוי מאחורי הפיד`
...
- Headline: `טלפון טראמפ הגיע, והלקוחות מצאו מכשיר סיני ממותג`
