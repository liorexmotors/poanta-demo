...
- Headline: `טראמפ רוצה הסכמי אברהם כחלק מהסדר עם איראן`
...
- Headline: `ישראל מרחיבה את התקיפות בלבנון אל בקעת הלבנון`
- Original: `Netanyahu says Israel will intensify strikes against Hezbollah`
- Source: BBC World
...
- Takeaway length 107 > 95
- Headline: `הטניסאית האוקראינית מחזירה את המלחמה לסבב הנשים`
...
- Headline: `צה״ל תקף בלבנון; יישובי גבול עוברים ללמידה מרחוק`
- Original: `צה"ל פתח בגל תקיפות בלבנון, נתניהו: "נגביר את המכות על חיזבאללה"`
- Source: גלובס - בארץ
...
- Headline: `חקירת מכרז אשכול מגיעה גם לבכיר ב־OPC`
...
- Takeaway length 103 > 95
- Headline: `נעצרו שני חשודים בניסיון רצח בירי בבני ברק`
- Original: `שני צעירים מהשרון נעצרו בחשד לניסיון רצח של גבר בבני ברק`
- Source: ynet - מבזקי החדשות
- URL: https://www.ynet.co.il/news/article/bjvokzflfx
...
- Takeaway length 102 > 95
- Headline: `שני חשודים נעצרו בעקבות פיצוץ רכב בחולון`
...
- Takeaway length 99 > 95
- Headline: `שבע תוכניות חדשות לרשויות לחיזוק התנדבות בחירום`
...
- Takeaway length 102 > 95
- Headline: `פסילת מצלמות LPR לא מבטלת דוחות חניה אוטומטית`
...
- Takeaway length 111 > 95
- Headline: `סאלח זועבי נרצח בנצרת; שלושה נורו בכפר יאסיף`
