...
- Headline: `ספסל הת׳אנדר קבע שיא והעלה אותם ל-1:2 במערב`
...
- Headline: `טורקיה הדיחה מנהיג אופוזיציה וסגרה אוניברסיטה ליברלית`
...
- Headline: `רשויות בצפון דורשות מצה״ל מענה לאיום הרחפנים`
...
- Headline: `בגליל: 11 התרעות ועשרה רחפנים מאז יום חמישי`
- Original: `"זו הפסקת אש? זה אש בלי הפסקה"`
...
- Original: `"עליית מחירים בעיר": בכמה נמכרה דירת 4 חדרים ביקנעם?`
...
- Headline: `בחירת נשיא העליון בכנסת מוצעת כפשרה למשבר המשפטי`
...
- Headline: `צה״ל בכוננות מחשש לתקיפה אמריקאית קרובה באיראן`
...
- Headline: `מכירת שיא למונדיאל לא ממלאת את המלונות בארה״ב`
...
- Takeaway length 115 > 95
- Headline: `רכישת דירה הופכת למבחן זוגי תחת יוקר הדיור`
- Original: `כשהדירה נכנסת באמצע: למה ריב על נדל"ן יכול לחסל נישואים`
- Source: גלובס - נדל״ן ותשתיות
- URL: https://www.globes.co.il/news/article.aspx?did=1001543571#utm_source=RSS

### WARNING · takeaway_long · item 15
- Takeaway length 101 > 95
- Headline: `איפא״ק יוצאת לקרבות פריימריז יקרים בארה״ב`
