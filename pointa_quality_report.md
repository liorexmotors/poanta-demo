...
- Headline: `קאן 2026 נוטה לסרטים קודרים ואלימים יותר`
...
- Headline: `מצרים זימנה למונדיאל את חלוץ הנוער של ברצלונה`
...
- Headline: `סאות׳המפטון הודחה מהפלייאוף בגלל ריגול`
...
- Headline: `מות רז אדם חושף צומת מסוכן בכביש 90`
...
- Headline: `הספרייה במטולה נפתחת מחדש תחת אזעקות`
...
- Headline: `המשטרה תפעיל כטב״ם סמוי נגד פשיעה בדרום`
...
- Headline: `השווקים באסיה קפצו על תקוות להסכם איראן-ארה״ב`
...
- Headline: `אוקלהומה השוותה את גמר המערב דרך ההגנה והספסל`
...
- Takeaway length 118 > 95
- Headline: `מותו של רז אדם בתאונת דרכים היכה את הכדורסל הישראלי`
...
- Takeaway length 108 > 95
- Headline: `ג׳וקוביץ׳ מצרף את טרויצקי לפני רולאן גארוס`
...
- Headline: `טראמפ בלם תקיפות באיראן ונתניהו לחץ לחדשן`
...
- Headline: `המאקרו חזק, אבל משקי הבית בישראל לא מרגישים הקלה`
...
- Headline: `ישראל מחזיקה יכולות חלל, אבל התקציב משאיר אותה מאחור`
...
- Headline: `כלי התמונות ב-AI השתפרו, אבל הפרומפט קובע את האיכות`
...
- Headline: `ניו ג׳רזי מגייסת סטארטאפים זרים עם SOSA`
