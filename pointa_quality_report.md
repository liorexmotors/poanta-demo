...
- Headline: `וומבניאמה לקח אחריות אחרי ההפסד לאוקלהומה`
...
- Headline: `פיורנטינה מעריכה את סולומון, אבל המחיר והכשירות מעכבים`
...
- Headline: `צה״ל שוקל לחדש תמרון בלבנון תחת לחץ הרחפנים`
...
- Headline: `90 נהרגו בפיצוץ במכרה פחם בסין; החילוץ נמשך`
...
- Headline: `צה״ל בכוננות לקראת אפשרות תקיפה אמריקנית באיראן`
...
- Takeaway length 107 > 95
- Headline: `איראן: הפערים מול ארה״ב עדיין עמוקים למרות התיווך`
...
- Headline: `מקסיקו ניצחה את גאנה במשחק הכנה למונדיאל`
...
- Takeaway length 107 > 95
- Headline: `תושב שדרות עוכב אחרי תאונת האופניים הקטלנית בכביש 4`
- Original: `תושב שדרות עוכב לחקירה בחשד למעורבות בתאונה הקטלנית בכביש 4`
- Source: ynet - מבזקי החדשות
- URL: https://www.ynet.co.il/news/article/rkjct6cyfl

### WARNING · summary_long · item 12
- Summary length 228 > 220
- Headline: `ה-FDA אישר טיפול ראשון להפטיטיס D כרונית`
...
- Headline: `ראשי הצפון דורשים מצה״ל ציוד נגד רחפני סיב`
...
- Takeaway length 128 > 95
- Headline: `אוסטרליה הצטרפה לגינוי הרחבת ההתנחלויות`
...
- Headline: `מלונאים בארה״ב מאשימים את פיפ״א בחדרי מונדיאל ריקים`
...
- Headline: `איפא״ק עוברת לפריימריז כדי לעצור שחיקה בתמיכה בישראל`
...
- Takeaway length 103 > 95
- Headline: `אבולה בקונגו מאיימת על השתתפות הנבחרת במונדיאל`
- Original: `מהומות, בידודים וחשש עולמי: התפרצות האבולה בקונגו הפכה לסיוט של המונדיאל`
- Source: ynet - כל ערוץ הספורט
- URL: https://www.ynet.co.il/sport/worldsoccer/article/s12vxit1me

### WARNING · takeaway_long · item 29
- Takeaway length 130 > 95
- Headline: `אברהם קליין חוזר להחלטות שעיצבו קריירת מונדיאלים`
...
- Headline: `תקיפות ישראל בלבנון הרגו 10 ולוחצות על הפסקת האש`
...
- Headline: `רוביו הגיע להודו כדי למכור אנרגיה בזמן משבר איראן`
...
- Takeaway length 106 > 95
- Headline: `מפקד מיליציה עיראקית הואשם בתכנון פיגועים נגד יהודים`
- Original: `מפקד המיליציה שנעצר תכנן להתנקש באיוונקה: "לשרוף את בית טראמפ"`
- Source: ynet - כל ערוץ החדשות
- URL: https://www.ynet.co.il/news/article/b15oboa1zl
...
- Takeaway length 121 > 95
- Headline: `הרוג ושישה פצועים בתאונה ליד קיבוץ גניגר`
...
- Takeaway length 118 > 95
- Headline: `מדריך מאי מרכז סדרות חדשות לפי תאריך ופלטפורמה`
...
- Takeaway length 118 > 95
- Headline: `גבארד תעזוב את ראשות המודיעין בסוף יוני`
...
- Summary length 223 > 220
- Headline: `גבארד פורשת אחרי מתיחות עם טראמפ סביב איראן`
...
- Takeaway length 109 > 95
- Headline: `בלו בירד תשיק קו נתב״ג–אמסטרדם ב-199 דולר לכיוון`
...
- Takeaway length 96 > 95
- Headline: `טור בהארץ מציג את ברכת נתניהו כמהלך הסחת אש`
- Original: `ברכת החג של נתניהו לעם ישראל היתה סרטון מפלג, מסית ומתקרבן`
- Source: הארץ - תרבות
- URL: https://www.haaretz.co.il/gallery/television/tv-review/2026-05-22/ty-article/.highlight/0000019e-4ea6-d37d-affe-ffeeeaa70000
...
### WARNING · category_sport_source · item 169
- Sport source should usually be ספורט
- Headline: `הצומת שבו נהרג רז אדם גבה שלושה חיים בשנה`
- Original: `שלושה הרוגים בשנה: על הצומת המסוכן בו נהרג רז אדם`
- Source: וואלה ספורט
