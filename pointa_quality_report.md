...
- Headline: `יישובי הצפון דורשים מצה״ל מענה לאיום הרחפנים`
...
- Headline: `סעודיה קלטה כבר 1.6 מיליון עולי רגל לחאג׳`
...
- Headline: `התפרצות אבולה מאיימת על השתתפות קונגו במונדיאל`
...
- Headline: `לבנון: 10 נהרגו בתקיפות ישראליות ביממה`
...
- Headline: `רוביו הגיע להודו כדי לקדם אנרגיה אמריקנית`
...
- Takeaway length 101 > 95
- Headline: `נאשם שהוסגר לארה״ב תכנן להתנקש באיוונקה טראמפ`
- Original: `ראה בסולימאני דמות אב - ותכנן להתנקש באיוונקה: "לשרוף את בית טראמפ"`
...
- Headline: `8 כורים נהרגו בפיצוץ גז במכרה פחם בסין`
...
- Takeaway length 100 > 95
- Headline: `Starship V3 נחתה באוקיינוס אחרי שיגור ניסוי ראשון`
...
- Takeaway length 114 > 95
- Headline: `גאברד תעזוב את ראשות המודיעין ב-30 ביוני`
...
### WARNING · category_sport_source · item 152
- Sport source should usually be ספורט
- Headline: `הצומת שבו נהרג רז אדם גבה שלושה חיים בשנה`
- Original: `שלושה הרוגים בשנה: על הצומת המסוכן בו נהרג רז אדם`
- Source: וואלה ספורט
