...
- Headline: `שוקולד מריר ללא סוכר פחות מזיק לשיניים מממתקים דביקים`
- Original: `הממתק שהכי פחות מזיק לשיניים: הבחירה המפתיעה של ד"ר מאיה רוזמן`
- Source: וואלה בריאות - כל הכתבות
- URL: https://healthy.walla.co.il/item/3840314

### WARNING · takeaway_long · item 5
- Takeaway length 110 > 95
- Headline: `אורה 5 ההיברידית נכנסת לפלח הקרוסאוברים המשפחתיים`
...
- Headline: `בנק ישראל חתך את הריבית ל-3.75% למרות מדד אפריל`
- Original: `בפעם השנייה השנה: בנק ישראל הוריד את הריבית`
- Source: וואלה כסף
- URL: https://finance.walla.co.il/item/3840606

### WARNING · takeaway_long · item 7
- Takeaway length 113 > 95
- Headline: `טראמפ רוצה לקשור הסכם עם איראן לנורמליזציה עם ישראל`
- Original: `Middle East crisis live: Trump suggests Gulf countries should sign Abraham accords recognising Israel under any deal`
...
- Headline: `הריבית ירדה ל-3.75% אחרי התייצבות האינפלציה`
...
- Headline: `שני חשודים נעצרו על פיצוץ רכב בחולון ללא נפגעים`
- Original: `תושבי תל אביב ובת ים נעצרו בחשד למעורבות בפיצוץ רכב בחולון בחודש אפריל`
- Source: ynet - מבזקי החדשות
- URL: https://www.ynet.co.il/news/article/b1bqppbggl

### WARNING · takeaway_long · item 10
- Takeaway length 118 > 95
- Headline: `חסימת הורמוז דוחפת את אסיה לנפט ברזילאי`
- Original: `Could Brazilian oil emerge as one of the big winners of the Iran war?`
- Source: Al Jazeera RSS מסונן מזרח תיכון
- URL: https://www.aljazeera.com/news/2026/5/25/could-brazilian-oil-emerge-as-one-of-the-big-winners-of-the-iran-war?traffic_source=rss
...
- Takeaway length 110 > 95
- Headline: `קלבריה של בנצי ארבל נפתחת מחדש בתל אביב`
- Original: `“אם הייתי יודע מה יקרה - לא הייתי פותח”: השף בנצי ארבל בראיון חשוף`
- Source: ישראל היום - כל הכתבות
- URL: https://www.israelhayom.co.il/food/restaurant-reviews/article/20604040
...
- Headline: `ישראל עשירה במאקרו, אבל השכר קונה פחות`
...
- Takeaway length 113 > 95
- Headline: `יציאת מכליות מהורמוז הפילה את הנפט ותמכה בשווקים`
- Original: `עליות של יותר מ-1.5% באירופה; מחירי הנפט צונחים על רקע תקוות לסיום המלחמה`
...
- Headline: `טראמפ קושר את ההסכם עם איראן להצטרפות להסכמי אברהם`
...
- Headline: `שחיין קיבל מיליון דולר על שיא שלא יוכר`
...
- Headline: `הרצוג שוחח עם אלופת אירופה בגלישת רוח`
...
- Original: `ליברמן על שאיפת איזנקוט להיות ראש ממשלה: "אלוף לא הופך מיד לרמטכ"ל"`
- Source: ynet - כל ערוץ החדשות
- URL: https://www.ynet.co.il/news/article/r1p4k311xzx
...
- Headline: `ועדת הכספים אישרה לקדם שליטה ממשלתית בתקציב תאגיד השידור`
- Original: `אושרה בקריאה ראשונה הצעת החוק להכפפת תקציב תאגיד השידור לאישור הממשלה`
- Source: גלובס - שיווק וצרכנות
- URL: https://www.globes.co.il/news/article.aspx?did=1001543846#utm_source=RSS
...
- Takeaway length 110 > 95
- Headline: `איראן מבהירה שהסכם עם ארה״ב עדיין אינו קרוב`
...
- Summary length 223 > 220
- Headline: `מניות הנדל״ן והבנייה זינקו בת״א לקראת הורדת ריבית`
- Original: `עליות חדות בבורסת ת"א. אלו המדדים שמזנקים`
- Source: גלובס - שוק ההון
...
- Takeaway length 97 > 95
- Headline: `מועצת ההתנדבות מציעה לרשויות תוכניות חוסן`
...
- Takeaway length 110 > 95
- Headline: `תומכי פהלווי ו-MEK מתעמתים גם בלונדון`
- Original: `Opposition divided: battle among Iranian regime’s opponents plays out on London streets`
- Source: The Guardian Middle East
- URL: https://www.theguardian.com/world/2026/may/25/iran-regime-opponents-london-shah-pahlavi-mek

### WARNING · summary_long · item 89
- Summary length 234 > 220
- Headline: `רוביו: אם שיחות איראן ייכשלו, ארה״ב תפעל אחרת`
...
- Headline: `סאלח זועבי נורה למוות בנצרת; שלושה נפצעו בכפר יאסיף`
...
- Takeaway length 100 > 95
- Headline: `חוק הנוחבות תקוע במחלוקת תקציבית של מיליארד שקל`
- Original: `חוק הנוחבות תקוע בגלל מחלוקת בין כ"ץ לסמוטריץ' - על תקציב: "הציבור לא יסלח"`
- Source: ynet - כל ערוץ החדשות
- URL: https://www.ynet.co.il/news/article/bjdp0wwxgl
...
### WARNING · category_sport_source · item 163
