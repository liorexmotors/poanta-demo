...
- Headline: `רונאלדו שוב בראש דירוג ההכנסות של פורבס`
...
- Headline: `סגל אנגליה של טוכל הצית ביקורת לפני המונדיאל`
...
- Headline: `הפנטגון פתח לציבור 46 סרטוני עב״מים ומסמכים מסווגים`
...
- Headline: `איראן מצננת ציפיות להסכם קרוב עם ארה״ב`
...
### WARNING · category_sport_source · item 157
- Sport source should usually be ספורט
- Headline: `הצומת שבו נהרג רז אדם גבה שלושה חיים בשנה`
- Original: `שלושה הרוגים בשנה: על הצומת המסוכן בו נהרג רז אדם`
- Source: וואלה ספורט
