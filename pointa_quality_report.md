...
- Headline: `שיי החזיר את אוקלהומה ל-1:1 מול הספרס`
...
- Headline: `בית״ר תפתח מו״מ מהיר עם ברק יצחקי`
...
- Headline: `SpaceX מבקשת הנפקה בשווי 1.5 טריליון דולר`
...
- Headline: `ההשתלטות השקטה על המשט הפכה למופע פוליטי באשדוד`
- Original: `שר הילדותיות והטמטום: בן גביר העניק לחמאס את המתנה הגדולה`
- Source: מעריב - חדשות
- URL: https://www.maariv.co.il/news/military/article-1323976

### WARNING · takeaway_long · item 8
- Takeaway length 125 > 95
- Headline: `תקוות להסכם עם איראן הזניקו מניות שבבים באסיה`
...
- Headline: `טראמפ עצר את חידוש התקיפות באיראן למרות לחץ נתניהו`
...
- Takeaway length 118 > 95
- Headline: `Subway סגרה אלפי סניפים כי איבדה גם מחיר וגם טריות`
...
- Headline: `ברזיל מחזירה את ניימאר כמבחן משמעת לאנצ׳לוטי`
- Original: `ניימאר חייב לשנות גישה כדי לעזור לברזיל`
- Source: ynet - כל ערוץ הספורט
- URL: https://www.ynet.co.il/sport/article/h1dsuvsjgg
...
- Headline: `רוכשי דירות בודקים מי אחראי לפרויקט, לא רק את המחיר`
...
- Headline: `רוכשי הדירות הצעירים דורשים ממ״ד, גמישות וקהילה`
...
- Headline: `התחלות הבנייה בהתחדשות עירונית ירדו למרות הצורך במיגון`
...
- Takeaway length 102 > 95
- Headline: `תערוכה מציבה אהבה לסבית מבוגרת במרכז הפריים`
- Original: `"רציתי לבדוק איך נראית אינטימיות בין נשים בגיל השלישי"`
- Source: ynet - כל ערוץ יחסים
- URL: https://www.ynet.co.il/dating/pride/article/0nftszrjn
...
- Headline: `ארה״ב הסירה סנקציות משליחת האו״ם פרנצ׳סקה אלבנזה`
...
- Takeaway length 125 > 95
- Headline: `עדאלה טוען להתעללות בעצורי המשט ולמשבר דיפלומטי`
...
- Takeaway length 117 > 95
- Headline: `התקדמות במו״מ דוחה בינתיים תקיפה באיראן`
...
- Takeaway length 112 > 95
- Headline: `צווי 8 לקיץ מעמיקים את משבר האמון במילואים`
...
- Takeaway length 129 > 95
- Headline: `רחפני חיזבאללה פוגעים בשגרת זרעית ללא התרעה`
...
- Takeaway length 116 > 95
- Headline: `מפקדי מילואים הפכו לאבות בין חזית לבית`
...
- Takeaway length 111 > 95
- Headline: `בן גביר הפך את עצירת המשט למשבר דיפלומטי`
...
- Headline: `צה״ל הזהיר: חוק הגיוס לא סוגר את פערי הכוח`
...
- Takeaway length 110 > 95
- Headline: `ארה״ב הטילה סנקציות על מארגני משטים לעזה`
- Original: `US imposes sanctions on Gaza flotilla organisers: Why it matters`
- Source: Al Jazeera RSS מסונן מזרח תיכון
...
- Summary length 221 > 220
- Headline: `בג״ץ דחה עתירת ארגוני סיוע על פעילות בעזה ובגדה`
- Original: `בג"ץ דחה את עתירת הארגונים ההומניטריים שיאלצו להפסיק לפעול בעזה ובגדה`
- Source: הארץ - חדשות
...
- Original: `המהלך שטלטל את וושינגטון: איראן מצאה דרך לעצור את המלחמה`
- Source: מעריב - חדשות
- URL: https://www.maariv.co.il/news/world/article-1323753
...
- Takeaway length 109 > 95
- Headline: `צה״ל עצר חשודים עם נשק ליד נווה זוהר`
- Original: `כוחות צה"ל עצרו רכב ליד ים המלח - וזה מה שהתגלה בתוכו`
- Source: מעריב - חדשות
