...
- Headline: `יישובי הצפון דורשים מצה״ל מענה לרחפני חיזבאללה`
...
- Headline: `צה״ל בכוננות מחשש לתקיפה אמריקנית באיראן`
...
- Headline: `רונאלדו בראש דירוג הכנסות הספורטאים עם 300 מיליון דולר`
- Original: `רונאלדו מוביל, מסי שלישי: עשרת הספורטאים המרוויחים ביותר בעולם`
- Source: ynet - כל ערוץ הספורט
- URL: https://www.ynet.co.il/sport/worldsoccer/article/sykwbh01gl

### WARNING · takeaway_long · item 5
- Takeaway length 114 > 95
- Headline: `אוקלהומה ניצחה את הספרס בעזרת 76 נקודות מהספסל`
- Original: `בזכות שיא מועדון מפתיע: אוקלהומה גברה על סן אנטוניו והפכה ל-1:2`
- Source: ישראל היום - כל הכתבות
- URL: https://www.israelhayom.co.il/sport/article/20598528

### WARNING · takeaway_long · item 6
- Takeaway length 110 > 95
- Headline: `פיפ״א ביטלה חדרים והשאירה מלונות מונדיאל ריקים`
...
- Headline: `איפא״ק עוברת לקרבות פריימריז יקרים בארה״ב`
...
- Headline: `מאמנו לשעבר של מקגרגור שיתף סרטון אנטישמי קיצוני`
...
- Takeaway length 122 > 95
- Headline: `רוכב אופניים כבן 50 נהרג בתאונה בכביש 4`
- Original: `רוכב אופניים נהרג מפגיעת רכב בכביש 4, סמוך למחלף הדרים שבשרון`
- Source: ynet - מבזקי החדשות
- URL: https://www.ynet.co.il/news/article/bjeaxhckzl

### WARNING · takeaway_long · item 11
- Takeaway length 108 > 95
- Headline: `התפרצות אבולה מסבכת את הגעת קונגו למונדיאל`
...
- Takeaway length 110 > 95
- Headline: `ארה״ב מנסה למכור להודו אנרגיה בזמן משבר הורמוז`
...
- Headline: `40 אלף פונו בקליפורניה מחשש לפיצוץ מכל כימי`
...
- Headline: `פקיסטן וקטאר מנסות לייצב את הפסקת האש`
...
- Headline: `בניו יורק חידשו חוק נגד מימון פעילות ביו״ש`
...
- Takeaway length 102 > 95
- Headline: `גאברד פורשת מראשות המודיעין בסוף יוני`
...
- Headline: `טריבונל 7 באוקטובר יוכל לגזור עונש מוות`
...
- Takeaway length 110 > 95
- Headline: `גבארד פורשת אחרי עימותים עם טראמפ על איראן`
