...
- Headline: `ערכת CBT ביתית חדשה מיועדת לטיפול בחרדות ילדים`
...
- Headline: `ברקוביץ׳ ומגל התעמתו על סרטון הביביסט של הליכוד`
...
- Headline: `נאט״ו תרגל הגנה על גוטלנד מחשש למהלך רוסי מהיר`
...
- Headline: `התקווה לפתיחת הורמוז הורידה את הנפט והקפיצה את אירופה`
- Original: `בורסות אירופה עלו בכ-2%; ציפייה דרוכה להסכם עם איראן מפילה את הנפט בכ-6%`
...
- Headline: `אגמון–טולצ'ינסקי קולט משרד פטנטים ומרחיב קניין רוחני`
...
- Takeaway length 100 > 95
- Headline: `היורה ליד הבית הלבן כבר נעצר בעבר מול השירות החשאי`
...
- Headline: `ועדת הכלכלה מעכבת את רפורמת הטסטים`
...
- Headline: `טראמפ קושר את עסקת איראן להצטרפות להסכמי אברהם`
- Original: `"תחתמו מיד!": הדרישה הדרמטית של טראמפ מסעודיה וקטאר`
- Source: גלובס - בארץ
- URL: https://www.globes.co.il/news/article.aspx?did=1001543818#utm_source=RSS
...
- Headline: `גבר נורה למוות בנצרת; המשטרה מחפשת חשודים`
- Original: `האלימות בחברה הערבית: גבר כבן 50 נורה למוות בנצרת`
- Source: וואלה חדשות
- URL: https://news.walla.co.il/item/3840566
