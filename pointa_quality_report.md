...
- Headline: `גורמים אמריקניים: איראן התחייבה לוותר על אורניום מועשר`
...
- Headline: `הצעת איראן של טראמפ משאירה את השאלות הקשות פתוחות`
- Original: `Many Questions, Few Details in Latest Iran Peace Proposal`
- Source: New York Times Middle East
...
- Headline: `שרברב ממליץ על סודה לכביסה לפתיחת סתימות שומן`
...
- Headline: `ג'ירונה ומאיורקה ירדו, חטאפה השיגה כרטיס לאירופה`
...
- Headline: `נהג משאית נרצח ברמלה וגופתו הוצתה בתוך הרכב`
...
- Headline: `באר שבע חגגה אליפות אחרי 5:2 ומכוונת לגמר הגביע`
...
- Headline: `הפועל תל אביב סיימה בתיקו מול בית"ר ומכוונת לשדרוג`
...
- Headline: `שלושער של הארי קיין החזיר לבאיירן את הגביע הגרמני`
- Original: `צפו: הארי קיין כבש שלושער, באיירן מינכן זכתה גם בגביע הגרמני`
- Source: וואלה ספורט
- URL: https://sports.walla.co.il/item/3840189

### WARNING · takeaway_long · item 14
- Takeaway length 100 > 95
- Headline: `בית"ר והפועל תל אביב סיימו עונה מפתיעה ב-1:1 בטדי`
...
- Takeaway length 105 > 95
- Headline: `מכבי חיפה הביסה 2:5 את האלופה באר שבע לפני הגמר`
...
- Takeaway length 100 > 95
- Headline: `היורוליג בוחנת חלופה לפיינל פור באבו דאבי`
- Original: `מנכ"ל היורוליג: "מקווה שהכל ייפתר ונחזור לישראל בקרוב"`
- Source: וואלה ספורט - כדורסל
- URL: https://sports.walla.co.il/item/3840181
