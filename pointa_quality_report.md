...
- Headline: `סאות׳המפטון משלמת מחיר כבד על פרשת הריגול`
...
- Headline: `אל-חדת׳: בבסיס הישראלי בעיראק היו חמישה מסוקים`
...
- Headline: `ועדת גרוניס תבחן מחדש את מינוי רומן גופמן`
- Original: `רומן גופמן כבר היה בדרך למוסד - ואז הגיעה העדות של אורי אלמקייס`
- Source: מעריב - חדשות
- URL: https://www.maariv.co.il/news/law/article-1324118

### WARNING · takeaway_long · item 6
- Takeaway length 109 > 95
- Headline: `עולם הכדורסל נפרד מרז אדם אחרי התאונה הקטלנית`
...
- Headline: `איראן מסרבת להוציא את מלאי האורניום המועשר מהמדינה`
...
- Headline: `איראן משקמת כטב״מים בתוך חודשים למרות התקיפות`
- Original: `דו"ח מודיעין: איראן משקמת את מערך הנשק בקצב מטורף - וקובע תאריך אל חזור`
- Source: מעריב - חדשות
- URL: https://www.maariv.co.il/news/world/article-1324112

### WARNING · takeaway_long · item 9
- Takeaway length 109 > 95
- Headline: `קשת מלהקת את ברק ודן סרי לריאליטי הבישול`
...
- Headline: `רשתות ערביות קושרות כוח ישראלי לעימות בעיראק`
- Original: `רועה הצאן העיראקי שגילה את הבסיס הישראלי הסודי נחשף לראשונה`
- Source: מעריב - חדשות
- URL: https://www.maariv.co.il/news/world/article-1324116
...
- Headline: `גרוק כמעט לא נכנס לפרויקטי ה-AI של ממשל ארה״ב`
...
- Headline: `נבחרת איראן הגישה בקשות ויזה למונדיאל באנקרה`
...
- Headline: `משחקי הסימום יוצאים לדרך בלאס וגאס ביום ראשון`
...
- Takeaway length 100 > 95
- Headline: `בית״ר תארח את הפועל ת״א בשבת אחרי אובדן האליפות`
...
- Headline: `בריטניה זימנה נציג ישראלי בגלל סרטון בן גביר`
- Original: `UK summons Israel’s chargé d’affaires over video of minister taunting activists`
...
- Headline: `ישראל גירשה פעילי משט לעזה בצל גינוי בינלאומי`
...
- Headline: `רטטרוטייד הורידה עד 30% מהמשקל בניסוי שלב 3`
- Original: `זריקת ההרזיה ששברה שיא: ירידה של עד 38.5 ק"ג בתוך שנתיים`
- Source: מעריב - חדשות
- URL: https://www.maariv.co.il/news/health/article-1324097
...
- Headline: `טורקיה מפגינה יכולת אמפיבית רחבה בתרגיל אפס-2026`
...
- Headline: `רטטרוטייד עברה את רף 30% הירידה במשקל בניסוי`
