...
- Headline: `טראמפ על איראן: ״זה ייגמר בקרוב״`
- Original: `טראמפ על איראן: "תכף נסיים, זה ייגמר בקרוב"`
- Source: וואלה חדשות - מבזקים
- URL: https://news.walla.co.il/break/3840041

### WARNING · takeaway_long · item 2
- Takeaway length 99 > 95
- Headline: `הרוג ושישה פצועים בתאונה בכביש 73 ליד גניגר`
...
- Headline: `דליפת פחמן חד-חמצני הרגה 4 כורי פחם בסין`
- Original: `סין: 4 כורי פחם נהרגו אחרי שרמת הפחמן החד-חמצני חרגה מהמותר`
- Source: ynet - מבזקי החדשות
- URL: https://www.ynet.co.il/news/article/r17ydbayme

### WARNING · takeaway_long · item 4
- Takeaway length 111 > 95
- Headline: `ריאל מדריד הדיחה את ולנסיה ועלתה לגמר היורוליג`
...
- Takeaway length 99 > 95
- Headline: `בארה״ב נערכים לאפשרות של תקיפה נוספת באיראן`
- Original: `דיווח: "ממשל טראמפ מתכונן לתקוף שוב באיראן"`
- Source: ynet - כל ערוץ החדשות
- URL: https://www.ynet.co.il/news/article/skauv8a1fe

### WARNING · takeaway_long · item 7
- Takeaway length 108 > 95
- Headline: `פיצוץ במספנה בניו יורק פצע 16 בני אדם`
- Original: `ניו יורק: 16 פצועים בשריפה ופיצוץ במספנה בסטטן איילנד, 3 במצב קשה`
- Source: ynet - מבזקי החדשות
- URL: https://www.ynet.co.il/news/article/hjxtyl01zx

### WARNING · takeaway_long · item 8
- Takeaway length 108 > 95
- Headline: `רונאלדו שוב מוביל את דירוג ההכנסות של פורבס`
...
- Headline: `המו״מ עם איראן תקוע, וארה״ב חוששת מחידוש מלחמה`
...
- Takeaway length 100 > 95
- Headline: `בני זוג נמצאו מתים ברכב בשפלה; נבדק חשד לרצח והתאבדות`
- Original: `חשד לרצח והתאבדות: גבר ואישה אותרו ללא רוח חיים ברכב בשפלה`
- Source: ynet - כל ערוץ החדשות
- URL: https://www.ynet.co.il/news/article/hjd1pba1mg

### WARNING · takeaway_long · item 12
- Takeaway length 98 > 95
- Headline: `ראש המודיעין של טראמפ מתפטרת; גורם טוען שהודחה`
- Original: `"היא הודחה": ראש המודיעין של טראמפ טולסי גבארד מתפטרת`
- Source: ynet - כל ערוץ החדשות
- URL: https://www.ynet.co.il/news/article/skmca11rkgg

### WARNING · takeaway_long · item 13
- Takeaway length 118 > 95
- Headline: `חיסול אל־חדאד דוחף את חמאס לפיקוד חשאי ומבוזר יותר`
- Original: `"רוח הרפאים של אל-קסאם": מה מלמד חיסולו של אל-חדאד על חמאס?`
- Source: וואלה חדשות
- URL: https://news.walla.co.il/item/3839922

### WARNING · takeaway_long · item 14
- Takeaway length 107 > 95
- Headline: `סגל אנגליה של טוכל מצית ויכוח לפני מונדיאל 2026`
- Original: `אנגליה סוערת: רוני מגן על מגווייר, רוי קין עוקץ את הנדרסון`
- Source: וואלה ספורט - כדורגל עולמי
- URL: https://sports.walla.co.il/item/3840029

### WARNING · takeaway_long · item 15
- Takeaway length 129 > 95
- Headline: `טליה טימסית בת ה-11 מתה מפגיעת האוטובוס בדיזנגוף`
...
- Takeaway length 111 > 95
- Headline: `טראמפ מתקרב להחלטה על חידוש התקיפות באיראן`
- Original: `Trump met top advisers on Iran as he weighs return to war - Axios`
- Source: Axios Israel/Iran דרך Google News
- URL: https://news.google.com/rss/articles/CBMidkFVX3lxTE4wcmJGaFl5Si0yaXRJSUcxYld4MFVzaTl2YW5Vb2ppSnBwdVdUeGEzX25KSHBTaWlod0JrQU03dTJzT0JvMXJUY0p5TmhkX0lUNkhlWmpPcThfNVRiRXotWjFuaFlLV3pkUlMyN2E2a3Nvczd0REE?oc=5

### WARNING · takeaway_long · item 17
- Takeaway length 126 > 95
- Headline: `טראמפ יישאר בבית הלבן בגלל המתיחות עם איראן`
...
- Headline: `טולסי גבארד התפטרה מראשות המודיעין הלאומי בארה״ב`
- Original: `ראש המודיעין הלאומי של ארה"ב טולסי גבארד התפטרה`
- Source: וואלה חדשות - מבזקים
- URL: https://news.walla.co.il/break/3840024

### WARNING · takeaway_long · item 19
- Takeaway length 124 > 95
- Headline: `ארה״ב סנקרה תשעה בלבנון על קשרים לחיזבאללה`
...
- Headline: `רוביו: פקיסטן נשארת המתווכת המרכזית מול איראן`
...
- Headline: `פקיסטן וקטאר מנסות למנוע קריסת הפסקת האש`
...
- Headline: `מדריך מאי מרכז את סדרות הטלוויזיה החדשות לצפייה`
...
- Headline: `טולסי גאברד פורשת מראשות המודיעין האמריקאי`
...
- Headline: `מפקד צבא פקיסטן הגיע לטהרן לקדם הסכם ארה״ב-איראן`
- Original: `Pakistani field marshal in Tehran to try to seal U.S.-Iran deal - Axios`
- Source: Axios Israel/Iran דרך Google News
- URL: https://news.google.com/rss/articles/CBMicEFVX3lxTE54cnMzMjJqbXRTbzZXemRiTEQ2YWdwQk9VM01Ecng3Y29uWTJKMVRlNXpSc0tPY1IwSF85SnNqbHJLdVE5YkltODg3amk4cUJ1NW53TTN2YTJCak93ekJNZjV3eGUzYmJ5dmhVN2Mwemg?oc=5

### WARNING · takeaway_long · item 32
- Takeaway length 117 > 95
- Headline: `גבארד פורשת מראשות המודיעין הלאומי בארה״ב`
...
- Takeaway length 117 > 95
- Headline: `בני זוג נמצאו ירויים ברכב באזור משמר איילון`
...
- Headline: `בלו בירד פותחת קו ישיר מנתב״ג לאמסטרדם`
...
- Takeaway length 113 > 95
- Headline: `שני הרוגים בתאונות ליד מחלף חביבה ובכביש 77`
...
- Headline: `רוביו מציב את הסירוב האירופי באיראן על שולחן נאט״ו`
...
- Takeaway length 115 > 95
- Headline: `קטאר נכנסת למגעים לפתיחת מצר הורמוז`
...
- Headline: `לצבא בריטניה יש רחפנים לכמה ימי מלחמה בלבד`
...
- Headline: `פעילי המשט טוענים להתעללות מינית במעצר בישראל`
...
- Takeaway length 122 > 95
- Headline: `צרפת בוחנת הצטרפות לטילי עומק אירופיים`
...
- Takeaway length 113 > 95
- Headline: `דור פרץ ינסה להבטיח מלכות שערים לפני הגמר`
...
- Takeaway length 111 > 95
- Headline: `שבע מדינות מזהירות חברות מבנייה בהתנחלויות`
...
- Takeaway length 111 > 95
- Headline: `קטאר ופקיסטן מקדמות מתווה להפסקת אש עם איראן`
...
- Headline is a clipped/near-duplicate version of the summary
- Headline: `משלחת קטארית יצאה לטהרן בתיאום עם ארה״ב כדי לסייע במאמצים להגיע להסכם`
...
- Takeaway length 97 > 95
- Headline: `ז'אן מונטרו הפך את הדחייה מה-NBA לעונת שיא ביורוליג`
- Original: `חלום ה-NBA של ז'אן מונטרו התנפץ, והוא הפך לשחקן הטוב ביותר באירופה`
- Source: הארץ - ספורט
...
- Takeaway length 118 > 95
- Headline: `קליקאפ מפטרת 22% מהעובדים אחרי מהלך AI פנימי`
...
- Takeaway length 108 > 95
- Headline: `טוכל השאיר את פודן ופאלמר מחוץ לסגל אנגליה למונדיאל`
...
- Takeaway length 113 > 95
- Headline: `הפועל תל אביב צירפה את קיאנדרה קוק לפלייאוף`
...
- Takeaway length 109 > 95
- Headline: `Market API מחברת את מחיר המדף לקופה בזמן אמת`
