...
- Headline: `הפועל תל אביב תסיים עונת חזרה בטדי מול בית״ר`
...
- Headline: `פיינל פור היורוליג מעמיד שלושה מאמנים במבחן קריירה`
...
- Headline: `טוכל ניפה כוכבים מסגל אנגליה כדי לבנות אמון`
...
- Headline: `אנגליה פרסמה סגל מונדיאל בלי פודן, פאלמר ומגווייר`
...
- Headline: `אנשי אסד בלבנון מסייעים להברחת נשק וכסף לחיזבאללה`
- Original: `אנשי משטר אסד שנמלטו מסוריה ללבנון מנצלים קשרים כדי להבריח נשק וכספים`
- Source: וואלה חדשות - מבזקים
- URL: https://news.walla.co.il/break/3839975
...
- Headline: `דוח לקונגרס מונה 42 כלי טיס שאיבדה ארה״ב באיראן`
...
- Headline: `הודו מגדילה יבוא נפט מוונצואלה בגלל סגירת הורמוז`
...
- Headline: `המלחמה באיראן מסכנת את קרשי ההצלה של מצרים`
...
- Takeaway length 99 > 95
- Headline: `אישום: עקיפה בכפר הובילה למארב בגרזן בחתונה`
...
- Headline: `הביקוש לעורכי דין זינק ב־52% בשוק העבודה`
...
- Takeaway length 108 > 95
- Headline: `Market API מעדכנת מבצעים בסופר ישירות למדף`
...
- Takeaway length 119 > 95
- Headline: `Loora צמחה ל־15 מיליון משתמשים בלימוד אנגלית ב־AI`
...
- Takeaway length 117 > 95
- Headline: `חקלאות העוטף חזרה לתפקוד אחרי 7 באוקטובר`
...
- Headline: `הניו יורק טיימס מגן על טור קריסטוף נגד ישראל`
...
### WARNING · category_sport_source · item 84
...
- Takeaway length 97 > 95
- Headline: `ארה״ב הסירה זמנית סנקציות מפרנצ׳סקה אלבנזה`
