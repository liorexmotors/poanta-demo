...
- Headline: `מדריך מאי מרכז את הסדרות החדשות שיעלו בישראל`
...
- Headline: `בית״ר והפועל ת״א יסיימו עונה בהרכבים חסרים בטדי`
...
- Headline: `אינייסטה יפתח את קריירת האימון בגולף יונייטד בדובאי`
...
- Headline: `רוביו מזהיר מקרע בנאט״ו סביב התקיפה באיראן`
...
- Takeaway length 101 > 95
- Headline: `קטאר נכנסת לתיווך ישיר בין ארה״ב לאיראן`
- Original: `דיווח: קטאר שלחה משלחת לאיראן בתיאום עם ארה"ב`
- Source: וואלה חדשות - מבזקים
- URL: https://news.walla.co.il/break/3840000
...
- Headline: `בלאס וגאס ייפתחו משחקים שמתירים חומרים משפרים`
...
- Takeaway length 115 > 95
- Headline: `רוכב אופנוע בן כ-20 נהרג בתאונה בכביש 77`
...
- Headline: `13 צעירים נעצרו אחרי כניסה בכוח להר הבית`
- Original: `13 נעצרו לאחר שפרצו להר הבית כדי להקריב קורבן לשבועות`
- Source: ynet - מבזקי החדשות
- URL: https://www.ynet.co.il/news/article/bj865eckme

### WARNING · takeaway_long · item 18
- Takeaway length 113 > 95
- Headline: `פעילי המשט טוענים להתעללות קשה במעצר בישראל`
...
- Headline: `צרפת בוחנת הצטרפות לטילי תקיפה אירופיים`
...
### WARNING · headline_near_duplicate_summary · item 26
...
- Headline: `מדינות המפרץ לוחצות על טראמפ לעצור הסלמה מול איראן`
...
- Takeaway length 103 > 95
- Headline: `מחקר מסביר איך הפירמידה הגדולה שורדת רעידות`
...
### WARNING · headline_near_duplicate_summary · item 90
- Headline is a clipped/near-duplicate version of the summary
...
- Takeaway length 102 > 95
- Headline: `הניו יורק טיימס דוחה ביקורת על טור קריסטוף`
...
### WARNING · category_sport_source · item 146
- Sport source should usually be ספורט
- Headline: `הצומת שבו נהרג רז אדם גבה שלושה חיים בשנה`
- Original: `שלושה הרוגים בשנה: על הצומת המסוכן בו נהרג רז אדם`
- Source: וואלה ספורט
...
### WARNING · headline_near_duplicate_summary · item 169
- Headline is a clipped/near-duplicate version of the summary
