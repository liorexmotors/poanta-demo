...
- Headline: `רונאלדו שוב בראש דירוג הספורטאים המרוויחים`
...
- Headline: `בת 11 מתה אחרי תאונת האוטובוס בדיזנגוף`
...
- Headline: `המו״מ עם איראן תקוע וטראמפ חושש מחידוש מלחמה`
...
### WARNING · headline_near_duplicate_summary · item 9
- Headline is a clipped/near-duplicate version of the summary
- Headline: `ארה״ב הטילה סנקציות על תשעה בני אדם בלבנון, בהם שני קצינים`
...
- Takeaway length 98 > 95
- Headline: `אולימפיאקוס דרסה את פנרבחצ׳ה ועלתה לגמר היורוליג`
...
- Headline: `פקיסטן וקטאר מנסות להציל את הפסקת האש עם איראן`
...
- Takeaway length 97 > 95
- Headline: `פקיסטן מנסה לתווך רגע לפני הסלמה אזורית`
...
- Headline: `מחוקקים בניו יורק חידשו הצעה נגד מימון התנחלויות`
...
- Headline: `מאי בטלוויזיה: פאודה חוזרת וסיטדל עומדת למבחן`
