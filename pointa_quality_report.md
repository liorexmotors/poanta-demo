...
- Headline: `מנהיגים יהודים בארה״ב דורשים התנצלות מלייטר`
...
- Headline: `האופוזיציה בטורקיה מערערת על הדחת מנהיגה`
- Original: `מנהיג מפלגת האופוזיציה בטורקיה התנגד להחלטת בית המשפט שהדיחה אותו: "בטלו את הפסיקה"`
- Source: מעריב - מבזקים
- URL: https://www.maariv.co.il/breaking-news/article-1324200
...
- Headline: `בית״ר תדרוש 2.5 מיליון יורו על בריאן קרבאלי`
...
- Headline: `אוניון מכוונת למכור את ענאן חלאילי ביותר מ-25 מיליון יורו`
...
- Takeaway length 96 > 95
- Headline: `ארה״ב מסמנת בכירים בלבנון כזרוע סיוע לחיזבאללה`
- Original: `ממשל טראמפ בסנקציות נגד בכירים "המסייעים לחיזבאללה". ביניהם - שגריר איראן בלבנון`
- Source: וואלה חדשות - מבזקים
...
- Headline: `פיינל פור היורוליג נפתח עם ולנסיה בהופעת בכורה`
...
- Headline: `שופט בארה״ב ביטל זמנית סנקציות על בכירת או״ם`
...
- Takeaway length 105 > 95
- Headline: `רונאלדו ואל־נאסר לקחו אליפות סעודית אחרי ארבע שנים`
- Original: `אחרי כמעט ארבע שנים: כריסטיאנו רונאלדו ואל-נאסר זכו באליפות סעודיה`
- Source: ynet - כל ערוץ הספורט
- URL: https://www.ynet.co.il/sport/worldsoccer/article/bky3c03kge

### WARNING · takeaway_long · item 18
- Takeaway length 110 > 95
- Headline: `גרמניה מאשימה שניים בתכנון חיסולים עבור איראן`
...
- Headline: `איראן מחליפה תעמולה דתית במסרים לאומיים וצבאיים`
...
- Headline: `SpaceX הפכה את ההנפקה להימור ענק על AI`
